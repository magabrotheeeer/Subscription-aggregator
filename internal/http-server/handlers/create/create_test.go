...
type mockStorage struct {
	CreateFunc func(ctx context.Context, entry models.Entry) (int, error)
}

func (m *mockStorage) CreateSubscriptionEntry(ctx context.Context, entry models.Entry) (int, error) {
