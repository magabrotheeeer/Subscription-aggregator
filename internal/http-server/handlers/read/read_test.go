...
type mockStorage struct {
	ReadFunc func(ctx context.Context, id int) (*models.Entry, error)
}

func (m *mockStorage) ReadSubscriptionEntry(ctx context.Context, id int) (*models.Entry, error) {
