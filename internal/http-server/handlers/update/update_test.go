...
type mockStorage struct {
	UpdateFunc func(context.Context, subs.SubscriptionEntry, int) (int64, error)
}

func (m *mockStorage) UpdateSubscriptionEntry(ctx context.Context, entry subs.SubscriptionEntry, id int) (int64, error) {
...
func TestUpdateHandler(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		storage := &mockStorage{
			UpdateFunc: func(ctx context.Context, entry subs.SubscriptionEntry, id int) (int64, error) {
	...
	t.Run("invalid id in url", func(t *testing.T) {
		body, _ := json.Marshal(subs.DummySubscriptionEntry{
