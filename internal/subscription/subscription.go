// Package subscription содержит доменные структуры, описывающие подписку,
...
type Entry struct {
	...
	EndDate     *time.Time // Дата окончания подписки (nil, если бессрочная)
}
...
type DummyEntry struct {
	...
	EndDate     string `json:"end_date,omitempty" validate:"omitempty"` // Дата окончания (опционально)
}
